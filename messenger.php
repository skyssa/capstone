...
?>
<html lang="en" class=" sizes customelements history pointerevents postmessage webgl websockets cssanimations csscolumns csscolumns-width csscolumns-span csscolumns-fill csscolumns-gap csscolumns-rule csscolumns-rulecolor csscolumns-rulestyle csscolumns-rulewidth csscolumns-breakbefore csscolumns-breakafter csscolumns-breakinside flexbox picture srcset webworkers"><!-- Mirrored from uitheme.net/sociala/default-message.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 20 Sep 2023 02:21:58 GMT --><head>
    <meta charset="UTF-8">
...
<body class="color-theme-blue mont-font loaded">
    ...
    <div class="main-wrapper">
        ...
        <div class="nav-header bg-white shadow-xs border-0">
            ...
            <a href="default-storie.html" class="p-2 text-center ms-0 menu-icon center-menu-icon"><i class="feather-globe font-lg bg-greylight btn-round-lg theme-dark-bg text-grey-500 "></i></a>
                ...
                <div class="nav-content">
                    <div class="nav-wrap bg-white bg-transparent-card rounded-xxl shadow-xss pt-3 pb-1 mb-2 mt-2">
                        ...
                        <ul class="mb-1 top-content">
                            ...
                            <li></li>
                            <li><a href="default-storie.html" class="nav-content-bttn open-font"><i class="feather-globe btn-round-md bg-gold-gradiant me-3"></i><span>Departments</span></a></li>
                            <li></li>
                            <li><a href="user-page.html" class="nav-content-bttn open-font"><i class="feather-user btn-round-md bg-primary-gradiant me-3"></i><span>User Profile </span></a></li>                        
                        </ul>
                    </div>
...
</body><!-- Mirrored from uitheme.net/sociala/default-message.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 20 Sep 2023 02:22:22 GMT --></html>