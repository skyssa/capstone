               ...
               <div id="navbar">
                    ...
                    <div id="nav2">
                         <!-- <i class="fa-solid fa-bars">
                              <select class="fa-solid fa-bars">
                                   <option><span>More</span></option>
                                   <option><a href="myprofile.html"><i class="fa-solid fa-person">My Profile</i></a></option>
                                   <option><?php
                         ...
                         <!-- <ul id="nav2ul">
                              <ol><a href="myprofile.html"><i class="fa-solid fa-person">My Profile</i></a></ol>
                              <ol><?php
                                   echo $_SESSION['fullname'];
                                   ?></ol>
                              <ol><a href="logout.php">Log Out</a></ol>
                         </ul>
                         <li><a href="#" onclick="menutoggle()"><i class="fa-solid fa-bars"></i><span>More</span></a>
                         </li> -->
                    </div>
