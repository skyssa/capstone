    ...
    <div id="camp-app">
        <div class="main-wrapper">
            ...
            <div class="nav-header bg-white shadow-xs border-0">
                <div class="nav-top">
                    <a href="teacherhome.html"><span class="d-inline-block fredoka-font ls-3 fw-600 text-current font-xxl logo-text mb-0">CampusComm BSED Page</span>
                    </a>
                            ...
                            <div class="col-xl-8 col-xxl-9 col-lg-8">
                                <div class="card w-100 shadow-xss rounded-xxl border-0 ps-4 pt-4 pe-4 pb-3 mb-3">
                                    <a href="#" class=" font-xssss fw-600 text-grey-500 card-body p-0 d-flex align-items-center"><i class="btn-round-sm font-xs text-primary feather-edit-3 me-2 bg-greylight"></i>Create
                                        Post</a>
                                    <!-- post -->
                                    <form enctype="multipart/form-data" @submit="fnSaveBsed($event)">
                                ...
                                <div class="card w-100 shadow-xss rounded-xxl border-0 p-4 mb-3" v-for="post in bsed">
                                            ...
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <form @submit="fnSavebsedAnnounce($event)">
                                                            <div class="form-group">
                                                    ...
                                                    <div class="modal-body" style="max-height: 60vh; overflow-y: auto;">
                                                        <div class="card mt-3" v-for="announces in absed" :key="announces.a_id">
                                ...
                                <div style=" overflow: scroll;" class="card w-100 shadow-xss rounded-xxl border-0 mb-3">
                                    <div class="card-body d-flex align-items-center  p-4 w-100 shadow-xss rounded-xxl border-0 mb-3">
                                        <div style="height: 70vh;">
                                            ...
                                            <div class="card-body d-flex pt-0 ps-4 pe-4 pb-3 overflow-hidden " v-for="event in ebsed">
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        <div class="modal-body" style="max-height: 60vh; overflow-y: auto;">
                                                            ...
                                                            <div class="card mt-3" v-for="event in ebsed">
                        ...
                        <div class="middle-sidebar-right-content bg-white shadow-xss rounded-xxl">
                            ...
                            <div class="section full pe-3 ps-4 pt-4 position-relative feed-body">
                                ...
                                <ul class="list-group list-group-flush">
                                    ...
                                    <?php
                                    $query_user = mysqli_query($conn, "SELECT * FROM tbl_user WHERE dep_type='BSED' ORDER BY dep_type='BSED' DESC");
