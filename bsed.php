          ...
          <div id="mainbox">
               <div id="navbar">
                    ...
                    <ul>
                         ...
                         <li id="fa-heart"><a href="studdepartment.php"><i class="fa-solid fa-fade fa-school"></i><span> Department</span></a>
                         </li>
                    </ul>
                    <div id="nav2">
               ...
               <div id="main2">
                    ...
                    <!-- <div class="container">
                         <h2 style="font-size: 20px; font-family:Verdana, Geneva, Tahoma, sans-serif">ANNOUNCEMENT</h2>

                         <button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#mymodess">Create Announcement</button>


                         <div class="modal fade" id="mymodess" role="dialog">
                              <div class="modal-dialog">
