    ...
    <div id="camp-app">
        <div class="main-wrapper">
            ...
            <div class="nav-header bg-white shadow-xs border-0">
                <div class="nav-top">
                    <a href="teacherhome.html"><span class="d-inline-block fredoka-font ls-3 fw-600 text-current font-xxl logo-text mb-0">Bsit Alumni Society</span>
                    </a>
                            ...
                            <div class="col-xl-8 col-xxl-9 col-lg-8">
                                <div class="card w-100 shadow-xss rounded-xxl border-0 ps-4 pt-4 pe-4 pb-3 mb-3">
                                    <a href="#" class=" font-xssss fw-600 text-grey-500 card-body p-0 d-flex align-items-center"><i class="btn-round-sm font-xs text-primary feather-edit-3 me-2 bg-greylight"></i>Create
                                        Post</a>
                                    <!-- post -->
                                    <form enctype="multipart/form-data" @submit="fnSavealumni($event)">
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <div class="comment-input-container">
                                                                <input type="hidden" name="postId" v-model="post.post_id">
                                                                <input v-model="commentText" class="comment-input" type="text" placeholder="Type your comment here" />
                                                                <button @click="fnAddCbsit(post.post_id, commentText)" class="comment-button fw-600 text-success ms-2">Comment</button>
                                                            </div>
                                                        </div>
                    ...
                    <div class="right-chat nav-wrap mt-2 right-scroll-bar">
                        <div class="middle-sidebar-right-content bg-white shadow-xss rounded-xxl">
                            ...
                            <div class="section full pe-3 ps-4 pt-4 position-relative feed-body">
                                ...
                                <?php
                                    $query_user = mysqli_query($conn, "SELECT * FROM tbl_user ORDER BY dep_type='Alumni' DESC");
