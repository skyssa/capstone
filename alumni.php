                ...
                <div id="camp-app">
                    <div class="main-wrapper">
                        ...
                        <div class="nav-header bg-white shadow-xs border-0">
                            <div class="nav-top">
                                <a href="teacherhome.html"><span class="d-inline-block fredoka-font ls-3 fw-600 text-current font-xxl logo-text mb-0">Alumni Homepage</span>
                                </a>
                                        ...
                                        <div class="col-xl-8 col-xxl-9 col-lg-8">
                                            <div class="card w-100 shadow-xss rounded-xxl border-0 ps-4 pt-4 pe-4 pb-3 mb-3">
                                                <a href="#" class=" font-xssss fw-600 text-grey-500 card-body p-0 d-flex align-items-center"><i class="btn-round-sm font-xs text-primary feather-edit-3 me-2 bg-greylight"></i>Create
                                                    Post</a>
                                                <!-- post -->
                                                <form enctype="multipart/form-data" @submit="Alumni($event)">
                                            ...
                                            <div class="card w-100 shadow-xss rounded-xxl border-0 p-4 mb-3" v-for="post in alumni" :key="post.post_id">
